'''Defines data models for BeeVibe app.

Includes models for Song, Playlist, Comment, corePlaylist,
PlaylistPage, PlaylistMetadata, PlaylistIterator.
...
class corePlaylist:
    '''A compact playlist object for search purposes.

    A smaller object with only id, title and creator,
    intended to be used in search queries.

    Args:
        p_id (int): ID of the playlist.
        title (string): Title of the playlist.
        creator (string): Name of the creator of the playlist.
    '''
    ...
    def to_dict(self):
        ...
        Returns:
            core (dict): Includes id, title and creator.
        '''
        core = {
            "id": self.id,
            "title": self.title,
